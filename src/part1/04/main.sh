...
echo -e "\nColumn 1 background = $(name_color "$b1")"
echo -e "Column 1 font color = $(name_color "$f1")"
echo -e "Column 2 background = $(name_color "$b2")"
echo -e "Column 2 font color = $(name_color "$f2")"
